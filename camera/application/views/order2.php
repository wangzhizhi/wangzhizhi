...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><span class="crumb-step"></span><span class="crumb-name">全部订单</span></div>
        </div>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        ?>
                            <tr>
                                ...
                                <th style="text-align: center"><?php if($order->order_state == 0){echo "待发货 <a href='backend/update_state'>点击发货</a>";}else if($order->order_state == 1){echo "已发货，待买家确认收货";}else{echo "交易完成";}?></th>
